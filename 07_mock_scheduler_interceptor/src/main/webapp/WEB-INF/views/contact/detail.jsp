...
<body>
  ...
  <div>
    <form id="frm-detail" method="POST">
      <div>
        <label for="contact-no">번호</label> <input type="text"
          id="contact-no" name="contact-no" value="${contact.contactNo}"
          readonly>
      </div>
      <div>
      ...
      <div>
        <label for="mobile">연락처</label> <input type="text" id="mobile"
